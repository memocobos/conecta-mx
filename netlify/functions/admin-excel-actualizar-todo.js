...
exports.handler = async (event) => {
  ...
  const acumulado = {
    ...
    boletos: suma((e) => ((e.plan && e.plan.boletos) || []).length),
    fuera: suma((e) => ((e.plan && e.plan.fuera) || []).length),
    avisos_boletos: suma((e) => ((e.plan && e.plan.avisos_boletos) || []).length),
    ...
    escritos: confirmar ? {
      ...
      boletos: suma((e) => ((e.resultado && e.resultado.boletos) || []).length),
      fuera: suma((e) => ((e.resultado && e.resultado.fuera) || []).length),
